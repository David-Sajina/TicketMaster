    ...
    <v-app>
      ...
      >
        <v-list-item>
          <v-list-item-avatar>
            <v-img
              src="https://images-ext-2.discordapp.net/external/T2jCEQcCfcuYtEbNM_QRoeTDgwUd149wLYEK7dQr0nU/https/www.pngkey.com/png/detail/202-2024932_profile-icon-question-mark-icon-svg.png?width=647&height=679"
            ></v-img>
          </v-list-item-avatar>
